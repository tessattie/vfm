...
class DepositsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'payment_type' => ['type' => 'tinyinteger', 'length' => 4, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null],
        'used' => ['type' => 'float', 'length' => null, 'precision' => null, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => ''],
        '_constraints' => [
    ...
    public function init()
    {
        $this->records = [
            [
                'id' => 1,
                'customer_id' => 1,
                'created' => '2019-09-20 18:34:46',
                'modified' => '2019-09-20 18:34:46',
                'amount' => 1,
                'rate_id' => 1,
                'payment_type' => 1,
                'used' => 1
