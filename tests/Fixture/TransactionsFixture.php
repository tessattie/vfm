...
class TransactionsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'deposit_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'customer_id' => 1,
                'account_id' => 1,
                'created' => '2019-11-17 15:59:58',
                'modified' => '2019-11-17 15:59:58',
                'amount' => 1.5,
                'type' => 1,
                'sale_id' => 1,
                'deposit_id' => 1,
